...
object MimeTypes {
    ...
    val MIME_APPLICATION_ANDREW_INSET = "application/andrew-inset"
    val MIME_APPLICATION_JSON = "application/json"
    val MIME_APPLICATION_ZIP = "application/zip"
    val MIME_APPLICATION_X_GZIP = "application/x-gzip"
    val MIME_APPLICATION_TGZ = "application/tgz"
    val MIME_APPLICATION_MSWORD = "application/msword"
    val MIME_APPLICATION_MSWORD_2007 = "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
    val MIME_APPLICATION_VND_TEXT = "application/vnd.oasis.opendocument.text"
    val MIME_APPLICATION_POSTSCRIPT = "application/postscript"
    val MIME_APPLICATION_PDF = "application/pdf"
    val MIME_APPLICATION_JNLP = "application/jnlp"
    val MIME_APPLICATION_MAC_BINHEX40 = "application/mac-binhex40"
    val MIME_APPLICATION_MAC_COMPACTPRO = "application/mac-compactpro"
    val MIME_APPLICATION_MATHML_XML = "application/mathml+xml"
    val MIME_APPLICATION_OCTET_STREAM = "application/octet-stream"
    val MIME_APPLICATION_ODA = "application/oda"
    val MIME_APPLICATION_RDF_XML = "application/rdf+xml"
    val MIME_APPLICATION_JAVA_ARCHIVE = "application/java-archive"
    val MIME_APPLICATION_RDF_SMIL = "application/smil"
    val MIME_APPLICATION_SRGS = "application/srgs"
    val MIME_APPLICATION_SRGS_XML = "application/srgs+xml"
    val MIME_APPLICATION_VND_MIF = "application/vnd.mif"
    val MIME_APPLICATION_VND_MSEXCEL = "application/vnd.ms-excel"
    val MIME_APPLICATION_VND_MSEXCEL_2007 = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
    val MIME_APPLICATION_VND_SPREADSHEET = "application/vnd.oasis.opendocument.spreadsheet"
    val MIME_APPLICATION_VND_MSPOWERPOINT = "application/vnd.ms-powerpoint"
    val MIME_APPLICATION_VND_RNREALMEDIA = "application/vnd.rn-realmedia"
    val MIME_APPLICATION_X_BCPIO = "application/x-bcpio"
    val MIME_APPLICATION_X_CDLINK = "application/x-cdlink"
    val MIME_APPLICATION_X_CHESS_PGN = "application/x-chess-pgn"
    val MIME_APPLICATION_X_CPIO = "application/x-cpio"
    val MIME_APPLICATION_X_CSH = "application/x-csh"
    val MIME_APPLICATION_X_DIRECTOR = "application/x-director"
    val MIME_APPLICATION_X_DVI = "application/x-dvi"
    val MIME_APPLICATION_X_FUTURESPLASH = "application/x-futuresplash"
    val MIME_APPLICATION_X_GTAR = "application/x-gtar"
    val MIME_APPLICATION_X_HDF = "application/x-hdf"
    val MIME_APPLICATION_X_JAVASCRIPT = "application/x-javascript"
    val MIME_APPLICATION_X_KOAN = "application/x-koan"
    val MIME_APPLICATION_X_LATEX = "application/x-latex"
    val MIME_APPLICATION_X_NETCDF = "application/x-netcdf"
    val MIME_APPLICATION_X_OGG = "application/x-ogg"
    val MIME_APPLICATION_X_SH = "application/x-sh"
    val MIME_APPLICATION_X_SHAR = "application/x-shar"
    val MIME_APPLICATION_X_SHOCKWAVE_FLASH = "application/x-shockwave-flash"
    val MIME_APPLICATION_X_STUFFIT = "application/x-stuffit"
    val MIME_APPLICATION_X_SV4CPIO = "application/x-sv4cpio"
    val MIME_APPLICATION_X_SV4CRC = "application/x-sv4crc"
    val MIME_APPLICATION_X_TAR = "application/x-tar"
    val MIME_APPLICATION_X_RAR_COMPRESSED = "application/x-rar-compressed"
    val MIME_APPLICATION_X_TCL = "application/x-tcl"
    val MIME_APPLICATION_X_TEX = "application/x-tex"
    val MIME_APPLICATION_X_TEXINFO = "application/x-texinfo"
    val MIME_APPLICATION_X_TROFF = "application/x-troff"
    val MIME_APPLICATION_X_TROFF_MAN = "application/x-troff-man"
    val MIME_APPLICATION_X_TROFF_ME = "application/x-troff-me"
    val MIME_APPLICATION_X_TROFF_MS = "application/x-troff-ms"
    val MIME_APPLICATION_X_USTAR = "application/x-ustar"
    val MIME_APPLICATION_X_WAIS_SOURCE = "application/x-wais-source"
    val MIME_APPLICATION_VND_MOZZILLA_XUL_XML = "application/vnd.mozilla.xul+xml"
    val MIME_APPLICATION_XHTML_XML = "application/xhtml+xml"
    val MIME_APPLICATION_XSLT_XML = "application/xslt+xml"
    val MIME_APPLICATION_XML = "application/xml"
    val MIME_APPLICATION_XML_DTD = "application/xml-dtd"
    val MIME_IMAGE_BMP = "image/bmp"
    val MIME_IMAGE_CGM = "image/cgm"
    val MIME_IMAGE_GIF = "image/gif"
    val MIME_IMAGE_IEF = "image/ief"
    val MIME_IMAGE_JPEG = "image/jpeg"
    val MIME_IMAGE_TIFF = "image/tiff"
    val MIME_IMAGE_PNG = "image/png"
    val MIME_IMAGE_SVG_XML = "image/svg+xml"
    val MIME_IMAGE_VND_DJVU = "image/vnd.djvu"
    val MIME_IMAGE_WAP_WBMP = "image/vnd.wap.wbmp"
    val MIME_IMAGE_X_CMU_RASTER = "image/x-cmu-raster"
    val MIME_IMAGE_X_ICON = "image/x-icon"
    val MIME_IMAGE_X_PORTABLE_ANYMAP = "image/x-portable-anymap"
    val MIME_IMAGE_X_PORTABLE_BITMAP = "image/x-portable-bitmap"
    val MIME_IMAGE_X_PORTABLE_GRAYMAP = "image/x-portable-graymap"
    val MIME_IMAGE_X_PORTABLE_PIXMAP = "image/x-portable-pixmap"
    val MIME_IMAGE_X_RGB = "image/x-rgb"
    val MIME_AUDIO_BASIC = "audio/basic"
    val MIME_AUDIO_MIDI = "audio/midi"
    val MIME_AUDIO_MPEG = "audio/mpeg"
    val MIME_AUDIO_X_AIFF = "audio/x-aiff"
    val MIME_AUDIO_X_MPEGURL = "audio/x-mpegurl"
    val MIME_AUDIO_X_PN_REALAUDIO = "audio/x-pn-realaudio"
    val MIME_AUDIO_X_WAV = "audio/x-wav"
    val MIME_CHEMICAL_X_PDB = "chemical/x-pdb"
    val MIME_CHEMICAL_X_XYZ = "chemical/x-xyz"
    val MIME_MODEL_IGES = "model/iges"
    val MIME_MODEL_MESH = "model/mesh"
    val MIME_MODEL_VRLM = "model/vrml"
    val MIME_TEXT_PLAIN = "text/plain"
    val MIME_TEXT_RICHTEXT = "text/richtext"
    val MIME_TEXT_RTF = "text/rtf"
    val MIME_TEXT_HTML = "text/html"
    val MIME_TEXT_CALENDAR = "text/calendar"
    val MIME_TEXT_CSS = "text/css"
    val MIME_TEXT_SGML = "text/sgml"
    val MIME_TEXT_TAB_SEPARATED_VALUES = "text/tab-separated-values"
    val MIME_TEXT_VND_WAP_XML = "text/vnd.wap.wml"
    val MIME_TEXT_VND_WAP_WMLSCRIPT = "text/vnd.wap.wmlscript"
    val MIME_TEXT_X_SETEXT = "text/x-setext"
    val MIME_TEXT_X_COMPONENT = "text/x-component"
    val MIME_VIDEO_QUICKTIME = "video/quicktime"
    val MIME_VIDEO_MPEG = "video/mpeg"
    val MIME_VIDEO_VND_MPEGURL = "video/vnd.mpegurl"
    val MIME_VIDEO_X_MSVIDEO = "video/x-msvideo"
    val MIME_VIDEO_X_MS_WMV = "video/x-ms-wmv"
    val MIME_VIDEO_X_SGI_MOVIE = "video/x-sgi-movie"
    val MIME_X_CONFERENCE_X_COOLTALK = "x-conference/x-cooltalk"

    private var mimeTypeMapping: HashMap<String, String>? = null
    private var extMapping: HashMap<String, String>? = null

    init {
        mimeTypeMapping = object : HashMap<String, String>(200) {
    ...
    init {
        extMapping = object : HashMap<String, String>(200) {
            private fun put1(key: String, value: String) {
                if (put(key, value) != null) {
                    throw IllegalArgumentException("Duplicated Mimetype: $key")
                }
            }
    ...
    fun getMimeType(ext: String): String {
        var mimeType: String? = lookupMimeType(ext)
        if (mimeType == null) {
    ...
    fun lookupExt(mimeType: String): String? {
        return extMapping!![mimeType.toLowerCase()]
    }
    ...
    fun getDefaultExt(mimeType: String): String {
        var ext: String? = lookupExt(mimeType)
        if (ext == null) {
            ext = "unknown"
        }
        return ext
